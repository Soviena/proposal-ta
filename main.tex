...
\title{Mengimplementasikan NestJS dan Prisma pada pengembangan Backend Monolitik pada aplikasi web Antria}\let\Title\@title   %Judul dalam bahasa Indonesia

\newcommand{\EngTitle}{Implementing Monolithic Backend Development with NestJS and Prisma for Antria's Web Application}  %Judul dalam bahasa Inggris
